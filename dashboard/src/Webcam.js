...
class Webcam {
   ...
   constructor(webcamElement, facingMode = 'user', canvasElement = null, snapSoundElement = null) {
     ...
     this._webcamElement.width = this._webcamElement.offsetWidth || 200;
     this._webcamElement.height = this._webcamElement.offsetHeight || 200;
   ...
   */
   ...
   snap() {
     if(this._canvasElement !== null){
       ...
       const sx = 0, sy = 0, dx = 0, dy = 0;
       const sWidth = width, sHeight = height;
       const dWidth = width, dHeight = height;

       console.log({ sx, sy, dx, dy, sWidth, sHeight, dHeight, dWidth, video: this._webcamElement });

       context.drawImage(this._webcamElement, sx, sy, sWidth, sHeight, dx, dy, dWidth, dHeight);
